...
"""
def D_Loss(D_Fake_Output, D_Real_Output, D_label_fake, loss_func, num_generators):#the loss function ... CE in this case
...
def G_Loss(D_Fake_Output, D_Real_Output, D_label_fake, loss_func, num_generators):#the loss function ... CE in this case
    D_fake_val = torch.sigmoid(D_Fake_Output[:, num_generators])
    D_true_val = torch.sigmoid(D_Real_Output[:, num_generators])
